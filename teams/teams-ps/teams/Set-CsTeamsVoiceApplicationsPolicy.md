...
Set-CsTeamsVoiceApplicationsPolicy 
 ...
 [-HistoricalTimeCallQueueMetricsPermission <string>]
 [-HistoricalTimeAgentMetricsPermission <string>]
 [[-Identity] <String>]
...
PARAMVALUE: None | AuthorizedOnly | All
...
### -HistoricalTimeAutoAttendantMetricsPermission

PARAMVALUE: None | AuthorizedOnly | All

When set to `None` (the default value), users affected by the policy won't receive historical metrics for auto attendants.
...
### -HistoricalTimeCallQueueMetricsPermission

PARAMVALUE: None | AuthorizedOnly | All

When set to `None` (the default value), users affected by the policy won't receive historical metrics for call queues.
...
### -HistoricalTimeAgentMetricsPermission

PARAMVALUE: None | AuthorizedOnly | All

When set to `None` (the default value), users affected by the policy won't receive historical metrics for agents.
